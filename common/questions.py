...
questions = {
    ...
    'q7': FoosTestQuestion(
        number=7,
        question=(
            'Прижатый или остановленный мяч, отправленный со средней линии, разрешается поймать на линии нападения, '
            'если он коснулся игрока средней линии противника, прежде чем был пойман.'
        ),
        options=['Да', 'Нет'],
        correct_answer_index=1,
    ),
    'q8': FoosTestQuestion(
        number=8,
        question=(
            'Прижатый или остановленный мяч, отправленный с линии защиты, разрешается поймать на средней линии, '
            'если он коснулся игрока линии нападения противника, прежде чем был пойман.'
        ),
        options=['Да', 'Нет'],
        correct_answer_index=0,
    ),
    'q9': FoosTestQuestion(
        number=9,
        question=(
            'Объявление сброса на средней линии также обнуляет число касаний мяча и борта.'
        ),
        options=['Да', 'Нет'],
        correct_answer_index=0,
    ),
    ...
    'q11': FoosTestQuestion(
        number=11,
        question='Какое наказание предусмотрено за засчитанный третий тайм-аут за одну игру?',
    ...
    'q12': FoosTestQuestion(
        ...
        options=[
            'Ввести мяч в игру с линии защиты',
    ...
    'q14': FoosTestQuestion(
        number=14,
        question=(
            'Защитник исполняет постановочный удар, который попадает в ворота противника, отскочив от фигурки игрока '
    ...
    'q18': FoosTestQuestion(
        number=18,
        question=(
            'Нападающий прижимает мяч фигуркой игрока на средней линии и бьет по воротам той же фигуркой. '
            'Мяч попадает в игрока его линии нападения, и он инстинктивно бьет им по мячу, с трудом попадая '
    ...
    'q21': FoosTestOpenQuestion(
        ...
        question=(
            ...
            'Каково разрешенное время активного владения на задней линии?'
        ),
        correct_answer='15 секунд',
    ),
    'q22': FoosTestOpenQuestion(
        number=22,
        question='Каково разрешенное время активного владения на средней линии?',
        correct_answer='10 секунд',
    ),
    'q23': FoosTestOpenQuestion(
        number=23,
        question='Каково разрешенное время активного владения на линии нападения?',
        correct_answer='15 секунд',
    ),
    ...
    'q25': FoosTestOpenQuestion(
        number=25,
        question='Каково разрешенное время паузы между играми?',
    ...
    'q26': FoosTestOpenQuestion(
        ...
        question=(
            ...
            'он остановился в мертвой зоне между средними линиями?'
        ),
    ...
    'q27': FoosTestOpenQuestion(
        ...
        question=(
            'Изначально мяч подавала команда А. С какой линии мяч вводится в игру после того, как '
            'он остановился в мертвой зоне в непосредственной близости к линии нападения команды Б?'
        ),
    ...
    'q28': FoosTestOpenQuestion(
        ...
        question=(
            'Изначально мяч подавала команда А. С какой линии мяч вводится в игру после того, как '
            'он остановился в мертвой зоне на задней линии команды А?'
        ),
        correct_answer='Линия защиты команды А',
    ),
    ...
    'q30': FoosTestOpenQuestion(
        ...
        question=(
            ...
            'Изначально мяч подавала команда А. С какой линии мяч вводится в игру после того, как '
            'команда А превысила время владения на линии нападения?'
        ),
        correct_answer='Линия защиты команды Б',
    ),
}
